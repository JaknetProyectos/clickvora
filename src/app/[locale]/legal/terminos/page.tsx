  ...
  return (
    <div className="legal-container">
      ...
      <section>
        ...
        <h2>DESCRIPCIÓN DE SERVICIOS OFRECIDOS</h2>
        <p>CLICKVORA es una empresa especializada en soluciones de desarrollo digital, ofreciendo:</p>
        ...
        <h3>Gamificación Empresarial</h3>
        <ul>
        ...
        <h3>Creación de Aplicaciones Móviles</h3>
        <ul>
        ...
        <ul>
          ...
          <li>Mantener indemne a CLICKVORA frente a cualquier reclamo derivado de los contenidos proporcionados por el cliente.</li>
        </ul>
        ...
        <p>CLICKVORA se compromete a tratar con confidencialidad la información que los clientes proporcionen durante el uso de los servicios, incluyendo datos técnicos, comerciales o cualquier material sensible compartido.</p>
        <p>De igual forma, el cliente reconoce que deberá mantener la confidencialidad respecto a cualquier información no pública de CLICKVORA a la que tenga acceso.</p>
        <p>La obligación de confidencialidad se mantiene incluso después de finalizado el servicio, salvo en los siguientes casos:</p>
        <ul>
        ...
        <p>CLICKVORA.com puede contener vínculos hacia sitios web de terceros (proveedores, socios, redes sociales). Estos enlaces se proporcionan únicamente por conveniencia.</p>
        <p>CLICKVORA no controla ni asume responsabilidad sobre:</p>
        <ul>
        ...
        <p>Le recomendamos leer términos y políticas de cualquier sitio externo que visite.</p>

        <h2>FUERZA MAYOR Y CAUSAS FUERA DE CONTROL</h2>
        ...
        <p>CLICKVORA se reserva el derecho de actualizar estos Términos y Condiciones en cualquier momento para reflejar cambios en:</p>
        <ul>
        ...
        <p>El uso continuado de nuestros servicios después de modificaciones constituye aceptación de los nuevos términos.</p>
        <p>Versión actual: 13/07/2025</p>
        <p>Consulte siempre la versión más reciente en: http://clickvora.com.mx//terminos</p>
        ...
        <p>Al utilizar el sitio web http://clickvora.com.mx/, contactar a CLICKVORA, solicitar cotizaciones o contratar servicios, usted declara:</p>
        <ul>
  ...
  return (
    <div className="legal-container">
      ...
      <section>
        ...
        <p>Always consult the most recent version at: http://clickvora.com.mx//terminos</p>
...
export default function LegalPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0f151c] flex-col">
